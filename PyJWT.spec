...
Source0  : https://files.pythonhosted.org/packages/b9/6d/e5ac4eb80724cb4201de6dcbc1e8a9f5cb65a0424b30c4c69e49bc1363d1/PyJWT-2.2.0.tar.gz
...
%prep
%setup -q -n PyJWT-2.2.0
cd %{_builddir}/PyJWT-2.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633623134
...
cp %{_builddir}/PyJWT-2.2.0/LICENSE %{buildroot}/usr/share/package-licenses/PyJWT/bc48b3f80bfc08458a1f78bb2b49c6de2b41010f
